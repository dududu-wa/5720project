"""
Wide ResNet (WRN-28-10) for CIFAR-10
Based on: https://github.com/szagoruyko/wide-residual-networks
"""
import torch
...
class WideResNet(nn.Module):
    def __init__(self, depth=28, widen_factor=10, dropout=0.0, num_classes=10):
...
def wrn28x10(num_classes=10, dropout=0.0):
    """WRN-28-10 model for CIFAR-10"""
    return WideResNet(depth=28, widen_factor=10, dropout=dropout, num_classes=num_classes)


def wrn40x4(num_classes=10, dropout=0.0):
    """WRN-40-4 model for CIFAR-10"""
    return WideResNet(depth=40, widen_factor=4, dropout=dropout, num_classes=num_classes)
